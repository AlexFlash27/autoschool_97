...
<div class="application-blankchild">
    ...
    <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
            ...
            <?= $form->field($model, 'issued_by')->textarea(['style'=>'width:85%']) ?>
            ...
            <?= $form->field($model, 'par_first_name')->textInput(['style'=>'width:85%'])->label('Имя'.$star) ?>

            <?= $form->field($model, 'par_last_name')->textInput(['style'=>'width:85%'])->label('Фамилия'.$star) ?>

            <?= $form->field($model, 'par_patronymic')->textInput(['style'=>'width:85%'])->label('Отчество'.$star) ?>

            <?= $form->field($model, 'par_phone_number')->widget(MaskedInput::className(), ['mask' => '+7 (999) 999-99-99'])->textInput(['style'=>'width:85%'])->label('Номер телефона'.$star) ?>

            <?= $form->field($model, 'par_place_registration')->textarea(['style'=>'width:85%'])->label('Место регистрации (по паспорту)'.$star) ?>

            <?= $form->field($model, 'par_place_residence')->textarea(['style'=>'width:85%'])->label('Место фактического проживания'.$star) ?>

            <h4>Паспортные данные</h4>
            <?= $form->field($model, 'par_series_number')->widget(MaskedInput::className(), ['mask' => '99 99 999999'])->textInput(['style'=>'width:85%'])->label('Серия и номер'.$star) ?>

            <?= $form->field($model, 'par_date_of_issue')->textInput(['type' => 'date', 'max' => '2999-12-31', 'style'=>'width:85%'])->label('Дата выдачи'.$star) ?>

            <?= $form->field($model, 'par_issued_by')->textarea(['style'=>'width:85%'])->label('Кем выдан'.$star) ?>

            <?= $form->field($model, 'par_department_code')->widget(MaskedInput::className(), ['mask' => '999-999'])->textInput(['style'=>'width:85%'])->label('Код подразделения'.$star) ?>

            <?= $form->field($model, 'par_date_of_birth')->textInput(['type' => 'date', 'max' => '2999-12-31', 'style'=>'width:85%'])->label('Дата рождения'.$star) ?>

            <?= $form->field($model, 'par_birthplace')->textInput(['style'=>'width:85%', 'value' => 'г. Ижевск'])->label('Место рождения'.$star) ?>
